...
export default function CzechiaPage() {
  ...
  const requirements = [
    ...
    "Знание чешского/английского языка",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="/prague-university-building-charles-bridge.jpg"
            alt="Чехия"
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 text-balance">Обучение в Чехии</h1>
          <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto text-pretty">
            Доступное качественное образование в самом центре Европы
          </p>
        </div>
      </section>
      ...
      <section className="py-12 container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold mb-6">Почему Чехия?</h2>
          <p className="text-lg text-muted-foreground leading-relaxed mb-8">
            Чехия предлагает одно из самых доступных европейских образований. Обучение на чешском языке в
            государственных университетах бесплатное! Страна находится в центре Европы, что дает отличные возможности
            для путешествий и карьерного роста в ЕС. Высокое качество жизни и низкие расходы делают Чехию идеальным
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <Card className="p-6 text-center">
              ...
              <div className="text-3xl font-bold mb-2">€0-5K</div>
            ...
            <Card className="p-6 text-center">
              ...
              <div className="text-3xl font-bold mb-2">D/C</div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <Card className="max-w-4xl mx-auto p-12 text-center bg-gradient-to-br from-primary/10 to-accent/10">
            <h2 className="text-4xl font-bold mb-4">Готовы начать обучение в Чехии?</h2>
