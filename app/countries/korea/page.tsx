...
export default function KoreaPage() {
  ...
  const requirements = [
    ...
    "TOPIK сертификат (для программ на корейском)",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img src="/korean-university-modern-campus-seoul.jpg" alt="Корея" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/40 to-background" />
        </div>
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          <div className="text-8xl mb-6">🇰🇷</div>
          <h1 className="text-5xl md:text-7xl font-bold mb-6 text-balance">Обучение в Корее</h1>
          <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto text-pretty">
            Инновации, передовые технологии и динамичная культура в сердце Азии
          </p>
        </div>
      </section>
      ...
      <section className="py-12 container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold mb-6">Почему Корея?</h2>
          <p className="text-lg text-muted-foreground leading-relaxed mb-8">
            Южная Корея стала одним из ведущих образовательных центров Азии, предлагая высококачественное образование в
            области технологий, инженерии, бизнеса и искусства. Корейские университеты известны своими инновационными
            подходами к обучению, современной инфраструктурой и сильными связями с ведущими мировыми компаниями, такими
            как Samsung, LG и Hyundai.
          </p>
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <Card className="p-6 text-center">
              ...
              <div className="text-3xl font-bold mb-2">$4-12K</div>
            ...
            <Card className="p-6 text-center">
              ...
              <div className="text-3xl font-bold mb-2">D-2</div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <Card className="max-w-4xl mx-auto p-12 text-center bg-gradient-to-br from-primary/10 to-accent/10">
            <h2 className="text-4xl font-bold mb-4">Готовы начать обучение в Корее?</h2>
