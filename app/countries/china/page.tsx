...
export default function ChinaPage() {
  ...
  const requirements = [
    ...
    "HSK сертификат (для программ на китайском)",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="/modern-chinese-university-campus-technology.jpg"
            alt="Китай"
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 text-balance">Обучение в Китае</h1>
          <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto text-pretty">
            Современные технологии, инновации и перспективы в самой динамичной экономике Азии
          </p>
        </div>
      </section>
      ...
      <section className="py-12 container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold mb-6">Почему Китай?</h2>
          <p className="text-lg text-muted-foreground leading-relaxed mb-8">
            Китай стремительно развивается как образовательный центр мирового уровня. Китайские университеты предлагают
            современные программы в области технологий, инженерии и бизнеса, а также уникальную возможность изучить один
            из самых востребованных языков мира и погрузиться в древнюю культуру.
          </p>
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <Card className="p-6 text-center">
              ...
              <div className="text-3xl font-bold mb-2">$3-10K</div>
            ...
            <Card className="p-6 text-center">
              ...
              <div className="text-3xl font-bold mb-2">X1/X2</div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <Card className="max-w-4xl mx-auto p-12 text-center bg-gradient-to-br from-primary/10 to-accent/10">
            <h2 className="text-4xl font-bold mb-4">Готовы начать обучение в Китае?</h2>
